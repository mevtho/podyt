...
export default function Welcome(props) {
    return (
        <>
            <Head title="Welcome" />
            <div className="relative flex items-top justify-center min-h-screen bg-primary-100 dark:bg-primary-900 sm:items-center sm:pt-0">
                <div className="fixed top-0 right-0 px-6 py-4 sm:block">
                    {props.auth.user ? (
                        <Link href={route('dashboard')} className="text-sm text-primary-700 underline">
                            Dashboard
                        </Link>
                    ) : (
                        <>
                            <Link href={route('login')} className="text-sm text-primary-700 underline">
                                Log in
                            </Link>

                            <Link href={route('register')} className="ml-4 text-sm text-primary-700 underline">
                                Register
                            </Link>
                        </>
                    )}
                ...
                <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
                    <div className="flex justify-center pt-8 sm:justify-start sm:pt-0">
                        <svg
                            ...
                            className="h-16 w-auto text-primary-700 sm:h-20"
                        >
                    ...
                    <div className="mt-8 bg-white dark:bg-primary-800 overflow-hidden shadow sm:rounded-lg">
                        <div className="grid grid-cols-1 md:grid-cols-2">
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-4 text-lg leading-7 font-semibold">
                                        <a
                                            ...
                                            className="underline text-primary-900 dark:text-white"
                                        >
                                            Documentation
                                        </a>
                                    </div>
                            ...
                            <div className="p-6 border-t border-primary-200 dark:border-primary-700 md:border-t-0 md:border-l">
                                <div className="flex items-center">
                                    <svg
                                        fill="none"
                                        stroke="currentColor"
                            ...
                            <div className="p-6 border-t border-primary-200 dark:border-primary-700">
                                <div className="flex items-center">
                                    <svg
                                        fill="none"
                                        stroke="currentColor"
                            ...
                            <div className="p-6 border-t border-primary-200 dark:border-primary-700 md:border-l">
                                <div className="flex items-center">
                                    <svg
                                        fill="none"
                                        stroke="currentColor"
                                    ...
                                    <div className="ml-4 text-lg leading-7 font-semibold text-primary-900 dark:text-white">
                                        Vibrant Ecosystem
                                    </div>
                                </div>
                    ...
                    <div className="flex justify-center mt-4 sm:items-center sm:justify-between">
                        <div className="text-center text-sm text-primary-500 sm:text-left">
                            <div className="flex items-center">
                                <svg
                                    fill="none"
                                    strokeLinecap="round"
                                    ...
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                    className="-mt-px w-5 h-5 text-primary-400"
                                >
                                ...
                                <svg
                                    ...
                                    strokeWidth="2"
                                    viewBox="0 0 24 24"
                                    className="ml-4 -mt-px w-5 h-5 text-primary-400"
                                >
                        ...
                        <div className="ml-4 text-center text-sm text-primary-500 sm:text-right sm:ml-0">
